...
Paper reviews with their implementations using [`Lucid² 💎`](https://github.com/ChanLumerico/lucid) library.

[⭐️ Velog Series](https://velog.io/@lumerico284/series/Paper-Review)

## Entries

1. [LeNet — Gradient-Based Learning Applied to Document Recognition](https://velog.io/@lumerico284/LeNet-Gradient-Based-Learning-Applied-to-Document-Recognition) [🔗](https://github.com/ChanLumerico/lucid/blob/main/lucid/models/imgclf/lenet.py)
